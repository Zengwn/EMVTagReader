...
public class EMVReader 
{
    ...
    public ArrayList<EnumCallback> mObjectList;
    ...
    public EMVReader(CardReader r,byte [] b,byte [] a)
    {
        ...
        aid=b;
        adf=a;
        mObjectList = new ArrayList<EnumCallback>(); 
    }
    
    public class EnumCallback
    {
        //for tagview display
        private String contents = "=== " + this.getClass().getSimpleName() + " ===" + "\n";
    ...
    class ReadPDOData extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("PDO %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadPDO extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("PDO %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadAppFCI extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("appFCI %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadApplicationDataFileRecord extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("app %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadApplicationDataFile extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("app %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadApplicationTemplate  extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("appTemp %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadFCIIssuerDiscretionaryData extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("FCIidd %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadFCIPropTemplate extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("FCIpt %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadPPSErecord extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("PPSE %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadPPSE extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("PPSE %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    boolean parse(EnumCallback c,byte [] data,int offset,int len) throws IOException
    {
        ...
        while (b && (len > 0))
        {
            ...
            c.contents = c.contents
                    + formatDisplayString(String.format("%04X", tag),
                            len, data, offset);
    ...
    public void read() throws IOException
    {
        ...
        //PPSE Select not successful 
        if (ppse[0] != 0x6F) {

            throw new IOException(HexTool.bytesToHexString(ppse));
        }
...
//            System.out.println(String.format("PDOL %04X,%d",tag,actLen));
    ...
    class ReadRecordData extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
    ...
    class ReadRecord extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
...
//            System.out.println(String.format("RR %04X,%d,",tag,len)+Hex.encode(data, offset, len));
    ...
    class ReadPSERecord extends EnumCallback
    {
        @Override
        public boolean found(int tag, int len, byte[] data, int offset) throws IOException 
        {
    ...
    private String formatDisplayString(String tag, int length, byte[] data, int offset) {
        return "  [" + tag + "] / length: " + String.format("%04X", length) + "\n"
                + HexTool.bytesToHexString(BinaryTools.bytesFrom(data, offset, length)) + "\n";
    }

    private void addMeToTrace(EnumCallback me) {
        if (mObjectList.contains(me)){
            Log.i(me.getClass().getSimpleName(),  " already added");
            return;
        }
